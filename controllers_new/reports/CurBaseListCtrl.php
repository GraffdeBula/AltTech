 ...
 * @author Andrey
 */
class ATCurBaseCtrl extends ControllerMain{
    protected $ContList=[];
    ...
    public function actionIndex(){
        ...
        $this->render('reports/ATCurBaseList',['BranchList'=>$this->BranchList]);
    }
    
    public function actionShowBrBase(){
        $this->ViewName='Отчёт по действующей базе - '.$_GET['BrName'];
        $PayList=(new ATP1ContMod())->getPaysByBranch($_GET['BrName'],$_GET['DateF'],$_GET['DateL']);
        $this->render('reports/ATCurBranchRep',['PayList'=>$PayList]);
    }
