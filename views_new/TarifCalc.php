        ...
        <div class="row">    
            ...
            <div class="col-5">
                ...
                <select id='MySelect' style="width: 550px" onchange="MySelectFunction(this.options[this.selectedIndex].value)"> 
                    ...
                    <option value="Кредит, который планируется списать, был направлен на погашение залогового кредита">13. Кредит, который планируется списать, был направлен на погашение залогового кредита</option>
