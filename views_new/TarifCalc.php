    ...
    <form>
        <div class="row">    
            ...
            <div class="col-5">
                ...
                <select id='MySelect' style="width: 550px" onchange="MySelectFunction(this.options[this.selectedIndex].value)"> 
                    <option></option>
                    ...
                    <option value="По причине предоставления кредитору заведомо ложных сведений при получении кредита правила об освобождении от исполнения обязательств не применяются">9. По причине предоставления кредитору заведомо ложных сведений при получении кредита правила об освобождении от исполнения обязательств не применяются</option>
                    <option value="Необходимо предоставить договор ГПХ, действующий в период получения кредитов для увеличения дохода">10. Необходимо предоставить договор ГПХ, действующий в период получения кредитов для увеличения дохода</option>
                    <option value="Наличие паев в собственности">11. Наличие паев в собственности</option>
                    <option value="Кредиты оформлены единовременно в короткий период (в т.ч. через брокера)/либо кредиты "свежие" взятые в срок до 3х месяцев">12. Кредиты оформлены единовременно в короткий период (в т.ч. через брокера)/либо кредиты "свежие" взятые в срок до 3х месяцев</option>
                    <option value="Кредит, который планируется списать, был направлены на погашение залогового кредита">13. Кредит, который планируется списать, был направлены на погашение залогового кредита</option>
                    <option value="В связи с привлечением клиента к ответственности по ряду статей УК/КОАП, есть риск, что правила об освобождении от исполнения обязательств не будут применены">14. В связи с привлечением клиента к ответственности по ряду статей УК/КОАП, есть риск, что правила об освобождении от исполнения обязательств не будут применены</option>
                    <option value="Учитывая трудоспособный возраст Заказчика и отсутствие официального дохода, есть риск введения процедуры реструктуризации долгов">15. Учитывая трудоспособный возраст Заказчика и отсутствие официального дохода, есть риск введения процедуры реструктуризации долгов</option>
                    <option value="Не утверждение локального плана реструктуризации в отношении жилого помещения, являющегося единственным жильем и предметом ипотеки в связи с наличием сделок">16. Не утверждение локального плана реструктуризации в отношении жилого помещения, являющегося единственным жильем и предметом ипотеки в связи с наличием сделок</option>
