                            ...
                            <?php
                                echo("<form method='get'>");
                                    ...
                                    echo("<p><label>Скидка по акции</label><select name='DISCACTION'>
                                        ...
                                        <option value='Клиент пенсионер:_12000'>Рекомендация: 12000</option>
                                        <option value='Клиент инвалид:_12000'>Рекомендация: 12000</option>
                                        <option value='Совместное банкротство (супруги):_9000'>Рекомендация: 9000</option>
                                        </select>
                                    ");    
