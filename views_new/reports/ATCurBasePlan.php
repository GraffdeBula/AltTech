    ...
    <body>        
        <?php
            foreach($BranchList as $Branch){  
                echo("<p>");
//                
//                echo("<a target='_blank' href='index_admin.php?controller=CurBasePlanCtrl&action=ShowBrBase&BrName={$Branch->BRNAME}&DateF=01.09.2024&DateL=30.09.2024'>"
//                    . "<button class='btn btn-warning'>{$Branch->BRNAME} - сентябрь 2024</button></a>"); 
//                echo("<a target='_blank' href='index_admin.php?controller=CurBasePlanCtrl&action=ShowBrBase&BrName={$Branch->BRNAME}&DateF=01.10.2024&DateL=31.10.2024'>"
//                    . "<button class='btn btn-danger'>{$Branch->BRNAME} - октябрь 2024</button></a>"); 
//                echo("<a target='_blank' href='index_admin.php?controller=CurBasePlanCtrl&action=ShowBrBase&BrName={$Branch->BRNAME}&DateF=01.11.2024&DateL=30.11.2024'>"
//                    . "<button class='btn btn-info'>{$Branch->BRNAME} - ноябрь 2024</button></a>"); 
...
//                    . "<button class='btn btn-danger'>{$Branch->BRNAME} - февраль 2024</button></a>");
                ...
                echo("<a target='_blank' href='index_admin.php?controller=CurBasePlanCtrl&action=ShowBrBase&BrName={$Branch->BRNAME}&DateF=01.06.2024&DateL=30.06.2024'>"
                    . "<button class='btn btn-info'>{$Branch->BRNAME} - июнь 2024</button></a>");
                echo("<a target='_blank' href='index_admin.php?controller=CurBasePlanCtrl&action=ShowBrBase&BrName={$Branch->BRNAME}&DateF=01.07.2024&DateL=31.07.2024'>"
                    . "<button class='btn btn-success'>{$Branch->BRNAME} - июль 2024</button></a>");
                echo("<a target='_blank' href='index_admin.php?controller=CurBasePlanCtrl&action=ShowBrBase&BrName={$Branch->BRNAME}&DateF=01.08.2024&DateL=31.08.2024'>"
                    . "<button class='btn btn-primary'>{$Branch->BRNAME} - август 2024</button></a>");    
                echo("</p>");
            }
        ?>        
    </body>
