...
class ReportsMod extends Model {
    public function getContP1(){
        ...
        $Sql="SELECT FIRST 150 tblClients.ClCode AS ClCode,tblP1Anketa.ContCode AS ContCode,ClFIO,FrOffice,FrPersManager,FrContDate,FrContProg,FrContTarif,FrContSum,ExTotDebtSum,DiscountSum"
